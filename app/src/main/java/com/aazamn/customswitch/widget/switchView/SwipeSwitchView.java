...
public class SwipeSwitchView  extends View {
    ...
    private boolean observeTouch=true;
    ...
    private SwipeSwitchView.OnCheckedChangeListener mOnCheckedChangeListener;
    ...
    private void parseAttributes(TypedArray a) {
        ...
        borderColor = a.getColor(R.styleable.switchView_borderColor,borderColor);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction() & MotionEvent.ACTION_MASK) {
                    case MotionEvent.ACTION_DOWN:
                        oldPoint = event.getX();
                        if(oldPoint>currentPoint+radus||oldPoint<currentPoint-radus)
                            observeTouch=false;
                        else {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        newPoint = currentPoint+(event.getX()-oldPoint);
                        if(newPoint>=minAllow && newPoint<=maxAllow && observeTouch) {
                            oldPoint = event.getX();
    ...
    private  void setUpPaint(){
        ...
        borderCircle = new Paint(Paint.ANTI_ALIAS_FLAG);
        borderCircle.setColor(borderColor);
        borderCircle.setAntiAlias(true);
        borderCircle.setStrokeWidth(borderStroke);
        borderCircle.setStyle(Paint.Style.STROKE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(new RectF(currentPoint-radus+borderStroke/2f,getPaddingTop()+borderStroke/2f,currentPoint+radus-borderStroke/2f,bottom-borderStroke/2f),0f,360,false, borderCircle);
        //canvas.restore();
    }
     ...
     */
    public void setOnCheckedChangeListener(@Nullable SwipeSwitchView.OnCheckedChangeListener listener){
    ...
    public interface OnCheckedChangeListener {
         ...
         *
         * @param swipeSwitchView The switch button view whose state has changed.
